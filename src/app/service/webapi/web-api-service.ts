...
export class WebApiService extends WebApiMockContent implements InMemoryDbService {
  ...
  foxStores = [
    ...
    // Самбор
    {
      ...
      stores: [
        {
          id: 1,
          position: { lat: 49.51509, lng: 23.196048 },
    ...
    // Северодонецк
    {
      ...
      stores: [
        {
          id: 1,
          position: { lat: 48.941857, lng: 38.51809 },
    ...
    // Фастов
    {
      ...
      stores: [
        {
          id: 1,
          position: { lat: 50.077378, lng: 29.91331 },
  ...
  userHandler: IDictionary<
    (info: RequestInfo, resOpt?: ResponseOptions) => any
  > = {
    post: info => null,
    get: info => {
