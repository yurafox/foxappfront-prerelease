...
//#region ACTION
  ...
  <div style="margin-top:10px;"><span style="font-size: 14px"><b>Осталось</b> <b>{{expire?.getDate()}}</b> дн. <b>{{expire?.getHours()}}</b> ч. <b>{{expire?.getMinutes()}}</b> м. <b>{{expire?.getSeconds()}}</b> с.</span>
</div>
`;
//#endregion
//#region PARTSPAY
