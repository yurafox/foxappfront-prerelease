...
//#endregion
//#region SAMSUNGGS8
const SAMSUNGGS8 = `<h3 style='text-align: center'>{{name}}</h3>
<div>
    <span class="default-container">Смартфон без границ</span><br>
    <img src="{{img_url}}-1.jpg">
    ...
    <span class="default-container">Экран</span><br>
    <img src="{{img_url}}-2.jpg">
    ...
    <span class="default-container">Камеры</span><br>
    ...
    <span class="default-container">Память и производительность</span><br>
    <img src="{{img_url}}-4.jpg">
    ...
    <span class="default-container">Безопасность</span><br>
    <img src="{{img_url}}-5.jpg">
    ...
    <span class="default-container">Дополнительные параметры</span><br>
