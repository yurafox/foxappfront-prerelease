...
export * from './account-menu/account-menu.module';
export * from './barcode/barcode.module';
...
export * from './manage-places-menu/manage-places-menu.module';
...
export * from './favorite-stores/favorite-stores.module';
